...
This repo contains an in-progress migration of Ramp's developer documentation into [Mintlify](https://mintlify.com). The goal is to rebuild the Ramp Developer portal (guides and API reference) on the Mintlify platform.
...
Migration is in progress. The API reference and core guide pages have been started; additional guides and concept pages are still being added.
